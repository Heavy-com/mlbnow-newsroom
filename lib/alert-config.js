...
const COMMON_TRADE = ['trade', 'traded', 'signed', 'free agent', 'contract',
  'extension', 'released', 'cut', 'waiver', 'claimed', 'waived', 'activated',
  'roster move', 'roster moves', 'roster update', 'practice squad', 'placed on'];
...
const CONFIGS = {
  mlb: {
    ...
    // GNews free tier is 100 req/day; news has produced no alerts and only
    // errors. Signal + transactions carry the feed. Flip to true to re-enable.
    includeNews: false,
    ...
    teams: {
      ...
      bluejays: { label: 'Toronto Blue Jays', emoji: '🐦', keywords: ['toronto blue jays', 'blue jays'], streams: ['Blue Jays'] },
      orioles: { label: 'Baltimore Orioles', emoji: '🧡', keywords: ['baltimore orioles', 'orioles'], streams: ['Orioles'] },
      rays: { label: 'Tampa Bay Rays', emoji: '🌤️', keywords: ['tampa bay rays', 'rays baseball'], streams: ['Rays'] },

      // AL Central
      guardians: { label: 'Cleveland Guardians', emoji: '⚔️', keywords: ['cleveland guardians', 'guardians'], streams: ['Guardians'] },
      tigers: { label: 'Detroit Tigers', emoji: '🐅', keywords: ['detroit tigers', 'tigers baseball'], streams: ['Tigers'] },
      royals: { label: 'Kansas City Royals', emoji: '👑', keywords: ['kansas city royals', 'royals'], streams: ['Royals'] },
      twins: { label: 'Minnesota Twins', emoji: '🇹', keywords: ['minnesota twins', 'twins baseball'], streams: ['Twins'] },
      whitesox: { label: 'Chicago White Sox', emoji: '⚫', keywords: ['chicago white sox', 'white sox'], streams: ['White Sox'] },

      // AL West
      astros: { label: 'Houston Astros', emoji: '🚀', keywords: ['houston astros', 'astros'], streams: ['Astros'] },
      mariners: { label: 'Seattle Mariners', emoji: '⚓', keywords: ['seattle mariners', 'mariners'], streams: ['Mariners'] },
      rangers: { label: 'Texas Rangers', emoji: '🤠', keywords: ['texas rangers', 'rangers baseball'], streams: ['Rangers'] },
      angels: { label: 'Los Angeles Angels', emoji: '😇', keywords: ['los angeles angels', 'angels baseball', 'anaheim angels'], streams: ['Angels'] },
      athletics: { label: 'Athletics', emoji: '🟢', keywords: ['oakland athletics', 'sacramento athletics', 'las vegas athletics', 'athletics baseball'], streams: ['Athletics'] },

      // NL East
      mets: { label: 'New York Mets', emoji: '🔵', keywords: ['new york mets', 'mets baseball', 'citi field'], streams: ['Mets'] },
      braves: { label: 'Atlanta Braves', emoji: '🪓', keywords: ['atlanta braves', 'braves'], streams: ['Braves'] },
      phillies: { label: 'Philadelphia Phillies', emoji: '🔔', keywords: ['philadelphia phillies', 'phillies'], streams: ['Phillies'] },
      marlins: { label: 'Miami Marlins', emoji: '🐟', keywords: ['miami marlins', 'marlins'], streams: ['Marlins'] },
      nationals: { label: 'Washington Nationals', emoji: '🇺🇸', keywords: ['washington nationals', 'nationals baseball'], streams: ['Nationals'] },

      // NL Central
      cubs: { label: 'Chicago Cubs', emoji: '🐻', keywords: ['chicago cubs', 'cubs baseball'], streams: ['Cubs'] },
      brewers: { label: 'Milwaukee Brewers', emoji: '🍺', keywords: ['milwaukee brewers', 'brewers'], streams: ['Brewers'] },
      cardinals: { label: 'St. Louis Cardinals', emoji: '🐦‍🔥', keywords: ['st. louis cardinals', 'st louis cardinals', 'cardinals baseball'], streams: ['Cardinals'] },
      reds: { label: 'Cincinnati Reds', emoji: '🔴', keywords: ['cincinnati reds', 'reds baseball'], streams: ['Reds'] },
      pirates: { label: 'Pittsburgh Pirates', emoji: '🏴‍☠️', keywords: ['pittsburgh pirates', 'pirates baseball'], streams: ['Pirates'] },

      // NL West
      dodgers: { label: 'Los Angeles Dodgers', emoji: '💙', keywords: ['los angeles dodgers', 'dodgers', 'ohtani'], streams: ['Dodgers'] },
      padres: { label: 'San Diego Padres', emoji: '🟤', keywords: ['san diego padres', 'padres'], streams: ['Padres'] },
      giants: { label: 'San Francisco Giants', emoji: '🌉', keywords: ['san francisco giants', 'giants baseball'], streams: ['Giants'] },
      diamondbacks: { label: 'Arizona Diamondbacks', emoji: '🐍', keywords: ['arizona diamondbacks', 'diamondbacks', 'dbacks'], streams: ['Diamondbacks'] },
      rockies: { label: 'Colorado Rockies', emoji: '🏔️', keywords: ['colorado rockies', 'rockies baseball'], streams: ['Rockies'] },
    },
  },
  ...
  nba: {
    ...
    teams: {
      ...
      lakers: { keywords: ['los angeles lakers', 'lakers basketball', 'lebron', 'luka', 'luka doncic', 'luka dončić'] },
      suns: { keywords: ['phoenix suns', 'suns basketball'] },
      kings: { keywords: ['sacramento kings', 'kings basketball'] },
      mavericks: { keywords: ['dallas mavericks', 'mavericks', 'mavs'] },
  ...
  nhl: {
    ...
    teams: {
      ...
      mammoth: { keywords: ['utah mammoth', 'mammoth hockey', 'utah hockey club', 'utah hc'] },
