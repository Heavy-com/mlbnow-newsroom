...
// Polls NewsAPI for NBA stories and posts to Slack
...
const SLACK_WEBHOOK = process.env.SLACK_NBA || 'https://hooks.slack.com/services/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';

const FRESHNESS_MS = 10 * 60 * 1000; // 10 min
