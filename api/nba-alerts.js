...
const QUERIES = ['NBA trade signing free agent roster move', 'NBA injury player out', 'Lakers Celtics Warriors Knicks Bulls Heat NBA', 'Bucks Nuggets Suns Mavericks Clippers Nets NBA'];
